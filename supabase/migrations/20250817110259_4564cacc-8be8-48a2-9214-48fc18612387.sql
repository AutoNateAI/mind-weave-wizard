-- Add reflection questions for sessions 1-10
INSERT INTO reflection_questions (session_number, lecture_number, question_number, question_text)
VALUES
  -- Session 1 questions
...
-- Add user reflections for admin@gmail.com with realistic content
...
WHERE rq.question_number = 1; -- Only add reflections for the first question of each lecture for now