-- Revert Problem Analysis Web and System Mapping templates to use proper AI generation
...
SET 
  ...
  content_slots = ARRAY[
    'central_problem', 'symptom_1', 'symptom_2', 'symptom_3', 'symptom_4',
    'root_cause_1', 'root_cause_2', 'root_cause_3', 'root_cause_4',
    'impact_1', 'impact_2', 'impact_3',
    'solution_1', 'solution_2', 'solution_3', 'solution_4',
    'expected_outcome_1', 'expected_outcome_2'
  ],
  ai_generation_prompt = 'Generate a problem analysis scenario based on the lecture content. Focus on breaking down a complex issue into its symptoms, root causes, impacts, and potential solutions. Create content that requires students to understand causal relationships and logical connections between different levels of analysis. Each slot should contain realistic, engaging content that helps students practice systematic problem-solving thinking.'
...
SET 
  ...
  content_slots = ARRAY[
    'system_core', 'input_1', 'input_2', 'input_3',
    'process_1', 'process_2', 'process_3', 'process_4',
    'output_1', 'output_2', 'output_3',
    'feedback_1', 'feedback_2',
    'constraint_1', 'constraint_2', 'constraint_3',
    'stakeholder_1', 'stakeholder_2',
    'system_outcome_1', 'system_outcome_2'
  ],
  ai_generation_prompt = 'Generate a system mapping scenario based on the lecture content. Focus on understanding how different components, processes, and stakeholders interact within a complex system. Create content that requires students to think about inputs, processes, outputs, feedback loops, constraints, and stakeholder relationships. Each slot should help students practice systems thinking and understand interconnected relationships.'
